...
for($sz =0; $sz < $size1; $sz++){
	...
	for($z =0; $z < $size2; $z++){
		...
		$product_match_status[$z] = array($array1[$sz], $array2[$z], $compare_status[0], $compare_status[1], $compare_status[2]);
	...
	for($psize=0; $psize < count($product_match_status); $psize++){
		...
		//echo $product_match_status[$psize][3].' ';
		//echo $product_match_status[$psize][4].'</br>';
		$word_count = $product_match_status[$psize][4];
		//echo $word_count.'</br>';
		if($product_match_status[$psize][2] == 0 && $product_match_status[$psize][3] == $word_count){
			...
			////echo $product_match_status[$psize][0].'||';
			////echo $product_match_status[$psize][1].' '.'</br>';
			$amazon_product = $product_match_status[$psize][1];
		}
		...
		if($product_match_status[$psize][2] == 1 && $product_match_status[$psize][3] == $word_count-3){
			$found_match = 1;
			////echo "Match Found".'</br>';
			////echo $product_match_status[$psize][0].'||';
			////echo $product_match_status[$psize][1].' '.'</br>';
	...
	/***************Loop through results again**********************/
		//echo "In the second match loop</br>";
		for($psize=0; $psize < count($product_match_status); $psize++){
		////echo $product_match_status[$psize][0].'||';
		////echo $product_match_status[$psize][1].' '.'</br>';
		////echo $product_match_status[$psize][2].' ';
...
function amazon_compare($string1, $array2){
...
for($sz =0; $sz < $size1; $sz++){
	...
	for($psize=0; $psize < count($product_match_status); $psize++){
		...
		if($product_match_status[$psize][2] == 0 && $product_match_status[$psize][3] == $word_count){
			...
			////echo $product_match_status[$psize][0].'||';
			////echo $product_match_status[$psize][1].' '.'</br>';
			$amazon_product = array($product_match_status[$psize][1], $psize);
		}
		if($product_match_status[$psize][2] == 0 && $product_match_status[$psize][3] == $word_count-1){
			$found_match = 1;
			////echo "Match Found".'</br>';
